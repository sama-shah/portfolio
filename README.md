...
- Stick to Major chords (C, D, E, F, G)
- Keep it bright and melodic

**House / Trap**
- Switch to **House** or **Trap** mode
- Use Minor and 7th chords for mood
- Layer in **Kick** and **Hat** for rhythm
- Add **Sweep** for build-ups

**Dark R&B**
- Use **Trap** mode
- Focus on Minor chords and 7th chords
- Slower BPM (70-90)
- Add **Snare** and subtle **Laser** effects

**Experimental**
- Mix modes between tracks
